...
def install():
    ...
    _get_route_handler = routing.request_response
    ...
    def _sw_get_route_handler(self, scope: Scope, receive: Receive, send: Send):
        ...
        with span:
            ...
            resp = _get_route_handler(self, scope, receive, send)
            print(resp)
            #if isawaitable(resp):
                #result = await resp
        ...
        return _get_route_handler(self, scope, receive, send)

    APIRoute.handle = _sw_get_route_handler
