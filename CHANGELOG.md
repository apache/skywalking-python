...
- Fixes:
  - Optimized agent TraceID/SegmentID logic to a simplified snowflake algorithm in sync with SkyWalking Java agent (#310)
    - This change speeds up ID generation by 4x, tracing core thus benefit from a ~30% performance gain.
    - Before v1.1.0: UUID4, Since v1.1.0: PROCESS_ID}.THREAD_ID.TIMESTAMP_SEQ(0-9999)
